...
function AddPatient() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    addItem('patients', { ...formData, date: new Date().toLocaleString() });
      ...
      <div className="container">
        <div className="card" style={{maxWidth: '800px', margin: '0 auto'}}>
          ...
          <form onSubmit={handleSubmit} style={{display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem'}}>
            ...
            <div className="form-group"><label>Disease / Condition</label><input required name="disease" onChange={handleChange}/></div>
